                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <form action="{{route('categories.store')}}" method="post">
                                ...
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    <!-- Existing fields -->
                                    <div>
                                        <label for="name_cat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">name_cat</label>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="px-4 py-4">Categories Id</th>
                                <th scope="col" class="px-4 py-4">Categories name</th>
                        ...
                        <tbody>
                           @foreach ($categories as $categorie)
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $categorie->id }}</th>
                                    <td class="px-4 py-3">{{ $categorie->name_cat }}</td>
